# db_asset_bundle_test

The 'db_asset_bundle_test' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] db_asset_bundle_test_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/db_asset_bundle_test.job.yml). The schedule
